        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-form v-on:submit.prevent>
            <b-form-input
              ...
              class="mr-sm-2"
              type="text"
              :placeholder="$t('shared.search_tasks')"
            />
            <b-button size="sm" class="my-2 my-sm-0" @click="searchEnter">
          ...
          <b-nav-item-dropdown :text="userDropdownText" right>
            <b-dropdown-item to="/users/edit" exact>
              <i class="fa fa-edit" aria-hidden="true"></i>
              {{ $t('shared.edit_settings') }}
            </b-dropdown-item>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(["userIsLoggedIn", "isAdministrator", "getAuthDetails"])
  },
